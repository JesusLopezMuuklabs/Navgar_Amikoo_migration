...
/*
 * TC85110 - Confirm columns can be ordered in ascending/descending order by
 * Original: muuk-tests/RunningFlows_Module/TestSteps_3845a028.spec.ts
 */
...
test('TC85110 - Confirm columns can be ordered in ascending/descending order', async ({ page }) => {
