...
/*
 * TC85113 - Confirm clicking on the flow instance name will open the corresponding drawer
 * Original: muuk-tests/RunningFlows_Module/TestSteps_3846cfa3.spec.ts
 */
...
test('TC85113 - Confirm clicking on the flow instance name will open the corresponding drawer', async ({ page }) => {
  ...
  // Click the TestRunningFlowTemplate link - opens drawer
  await runningFlowsPage.clickTestRunningFlowTemplateLink();

  // Assert we navigated into the instance
