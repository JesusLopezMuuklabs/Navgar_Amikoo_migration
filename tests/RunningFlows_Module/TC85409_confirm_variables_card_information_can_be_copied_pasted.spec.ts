...
/*
 * TC85409 - Confirm variables card information can be copied and pasted
 * Original: muuk-tests/RunningFlows_Module/TestSteps_ba254110.spec.ts
 */
...
test('TC85409 - Confirm variables card information can be copied and pasted', async ({ page }) => {
