...
/**
 * TC84306 - Confirm entities can be searched
 * Original: muuk-tests/Tasks_Module/TestSteps_0382a1fd.spec.ts
 */
...
test('TC84306 - Confirm entities can be searched', async ({ page }) => {
