...
/**
 * TC84308 - Confirm entities can be created
 * Original: muuk-tests/Tasks_Module/TestSteps_0382a414.spec.ts
 */
...
test('TC84308 - Confirm entities can be created', async ({ page }) => {
