...
/**
 * TC84313 - Confirm multiple entities can be assigned
 * Original: muuk-tests/Tasks_Module/TestSteps_0382a5fe.spec.ts
 */
...
test('TC84313 - Confirm multiple entities can be assigned', async ({ page }) => {
