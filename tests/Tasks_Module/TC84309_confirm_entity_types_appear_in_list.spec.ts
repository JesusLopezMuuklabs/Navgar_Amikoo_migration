...
/**
 * TC84309 - Confirm entity types appear in list
 * Original: muuk-tests/Tasks_Module/TestSteps_0382a476.spec.ts
 */
...
test('TC84309 - Confirm entity types appear in list', async ({ page }) => {
