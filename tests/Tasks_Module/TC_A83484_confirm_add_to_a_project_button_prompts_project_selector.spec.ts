...
/**
 * TC_A83484 - Confirm Add to a project button prompts project selector overlay
 * Original: muuk-tests/Tasks_Module/TestSteps_417d3b25.spec.ts
 */
...
test('TC_A83484 - Confirm Add to a project button prompts project selector overlay', async ({ page }) => {
