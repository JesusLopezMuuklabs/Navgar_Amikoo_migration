...
/**
 * TC_A70464 - Confirm Delete button deletes task
 * Original: muuk-tests/Tasks_Module/TestSteps_e5227938.spec.ts
 *
 * Flow:
 *   1. Login → Tasks → clean up → Create task
 *   2. Open task drawer → More → Delete → confirm dialog
 *   3. Assert grid is empty
 */
...
test('TC_A70464 - Confirm Delete button deletes task', async ({ page }) => {
