...
/**
 * TC84307 - Confirm entity types can be created
 * Original: muuk-tests/Tasks_Module/TestSteps_0382a3b0.spec.ts
 */
...
test('TC84307 - Confirm entity types can be created', async ({ page }) => {
