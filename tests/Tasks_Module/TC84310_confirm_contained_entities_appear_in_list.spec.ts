...
/**
 * TC84310 - Confirm contained entities appear in list when entity type has been selected
 * Original: muuk-tests/Tasks_Module/TestSteps_0382a4d8.spec.ts
 */
...
test('TC84310 - Confirm contained entities appear in list when entity type has been selected', async ({ page }) => {
