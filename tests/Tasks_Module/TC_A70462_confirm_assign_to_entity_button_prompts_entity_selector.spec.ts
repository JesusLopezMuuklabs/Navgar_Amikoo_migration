...
/**
 * TC_A70462 - Confirm Assign to entity button prompts entity selector overlay
 * Original: muuk-tests/Tasks_Module/TestSteps_e520b5c5.spec.ts
 */
...
test('TC_A70462 - Confirm Assign to entity button prompts entity selector overlay', async ({ page }) => {
