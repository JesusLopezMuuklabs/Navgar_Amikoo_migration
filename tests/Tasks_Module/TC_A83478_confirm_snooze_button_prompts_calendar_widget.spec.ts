...
/**
 * TC_A83478 - Confirm Snooze button prompts calendar widget
 * Original: muuk-tests/Tasks_Module/TestSteps_417d01df.spec.ts
 *
 * Flow:
 *   1. Login → Tasks → clean up → Create task
 *   2. Open task drawer → More → Snooze
 *   3. Assert date calendar widget is visible
 */
...
test('TC_A83478 - Confirm Snooze button prompts calendar widget', async ({ page }) => {
