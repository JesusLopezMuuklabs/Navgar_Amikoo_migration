...
/**
 * TC_A83482 - Confirm Set due date button prompts calendar widget
 * Original: muuk-tests/Tasks_Module/TestSteps_417d25f9.spec.ts
 */
...
test('TC_A83482 - Confirm Set due date button prompts calendar widget', async ({ page }) => {
