...
/**
 * TC_A83486 - Confirm Delete button deletes task
 * Original: muuk-tests/Tasks_Module/TestSteps_417d51b7.spec.ts
 */
...
test('TC_A83486 - Confirm Delete button deletes task', async ({ page }) => {
