...
/**
 * TC_A83485 - Confirm Assign to entity button prompts entity selector overlay
 * Original: muuk-tests/Tasks_Module/TestSteps_417d3f2a.spec.ts
 */
...
test('TC_A83485 - Confirm Assign to entity button prompts entity selector overlay', async ({ page }) => {
