...
/**
 * TC_A70469 - Delete task via options context menu (click on Log In, type email/password, click Tasks, create task, open options, delete)
 * Original: muuk-tests/Tasks_Module/TestSteps_e522dae6.spec.ts
 */
...
test('TC_A70469 - Delete task via options context menu', async ({ page }) => {
