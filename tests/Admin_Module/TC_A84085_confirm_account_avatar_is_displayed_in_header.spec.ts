...
/**
 * TC_A84085 - Confirm account avatar is displayed in header
 * Original: muuk-tests/Admin_Module/TestSteps_a4f91b90.spec.ts
 *
 * Flow:
 *   1. Login
 *   2. Open Profile Menu → Accounts (index 1)
 *   3. Assert Accounts heading is visible
 *   4. Assert account avatar image is visible in the list
 */
...
test('TC_A84085 - Confirm account avatar is displayed in header', async ({ page }) => {
  ...
  // Assert account avatar image is visible
  await adminPage.assertAccountAvatarVisible();
});
