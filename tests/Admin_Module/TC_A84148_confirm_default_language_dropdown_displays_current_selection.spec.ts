...
/**
 * TC_A84148 - Confirm Default language dropdown displays current language selection
 * Original: muuk-tests/Admin_Module/TestSteps_a4f238b0.spec.ts
 *
 * Flow:
 *   1. Login
 ...
 *   6. Assert Account Name and Default language labels are visible
 */
...
test('TC_A84148 - Confirm Default language dropdown displays current language selection', async ({ page }) => {
