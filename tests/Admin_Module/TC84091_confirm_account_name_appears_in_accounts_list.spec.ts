...
/**
 * TC84091 - Confirm account name appears in Accounts list
 * Original: muuk-tests/Admin_Module/TestSteps_a4fbc209.spec.ts
 *
 * Flow:
 *   1. Login
 *   2. Open Profile Menu → Accounts (index 1)
 *   3. Assert Accounts heading is visible
 *   4. Assert account name entry is visible in the list
 */
...
test('TC84091 - Confirm account name appears in Accounts list', async ({ page }) => {
  ...
  // Assert Accounts list loaded and account name is visible
