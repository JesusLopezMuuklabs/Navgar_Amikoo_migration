...
/**
 * TC84098 - Confirm user account name is listed in header
 * Original: muuk-tests/Admin_Module/TestSteps_a4fd1b74.spec.ts
 *
 * Flow:
 *   1. Login
...
test('TC84098 - Confirm user account name is listed in header', async ({ page }) => {
