...
/**
 * TC84099 - Confirm account avatar is displayed in header (account detail)
 * Original: muuk-tests/Admin_Module/TestSteps_a4fd1daa.spec.ts
 *
 * Flow:
 *   1. Login
 ...
 *   5. Assert account detail heading is visible
...
test('TC84099 - Confirm account avatar is displayed in header (account detail)', async ({ page }) => {
  ...
  // Assert account detail heading and user table visible
