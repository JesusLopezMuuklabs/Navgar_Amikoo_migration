...
/**
 * TC_A84152 - Confirm account name can be edited in the Full name field
 * Original: muuk-tests/Admin_Module/TestSteps_a4fab2c3.spec.ts
 *
 * Flow:
 *   1. Login
 ...
 *   6. Assert Account Name label is visible on the edit form
 */
...
test('TC_A84152 - Confirm account name can be edited in the Full name field', async ({ page }) => {
  ...
  // Assert Account Name label visible
