...
/**
 * TC_A84088 - Confirm added users appear in permissions list
 * Original: muuk-tests/Admin_Module/TestSteps_a4f93856.spec.ts
 *
 * Flow:
 *   1. Login
 ...
 *   5. Assert permissions table headers (User, Friendly code, Email, Phone number, Roles) are visible
 */
...
test('TC_A84088 - Confirm added users appear in permissions list', async ({ page }) => {
  ...
  // Assert user table columns are visible
