...
/**
 * TC_A84089 - Confirm Invite A User button triggers the user invite page
 * Original: muuk-tests/Admin_Module/TestSteps_a4f951b9.spec.ts
 *
 * Flow:
 *   1. Login
...
test('TC_A84089 - Confirm Invite A User button triggers the user invite page', async ({ page }) => {
