...
/**
 * TC84101 - Confirm Flow editor button is toggleable (account permissions)
 * Original: muuk-tests/Admin_Module/TestSteps_a4fd1e9c.spec.ts
 *
 * Flow:
 *   1. Login
...
test('TC84101 - Confirm Flow editor button is toggleable (account permissions)', async ({ page }) => {
  ...
  // Assert permissions page loaded
