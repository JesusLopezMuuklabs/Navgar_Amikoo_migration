...
/**
 * TC_A84146 - Confirm account avatar is displayed in header (Production Environment)
 * Original: muuk-tests/Admin_Module/TestSteps_a4f23886.spec.ts
 *
 * Flow:
 *   1. Login
...
test('TC_A84146 - Confirm account avatar is displayed in header (Production Environment)', async ({ page }) => {
  ...
  // Assert Production Environment link visible
