...
/**
 * TC_A84149 - Confirm account avatar image appears
 * Original: muuk-tests/Admin_Module/TestSteps_a4f2545e.spec.ts
 *
 * Flow:
 *   1. Login
 ...
 *   7. Assert the account avatar image on the edit form is visible
 */
...
test('TC_A84149 - Confirm account avatar image appears', async ({ page }) => {
  ...
  // Assert the production environment avatar is visible
  await adminPage.assertProductionEnvironmentAvatarVisible();
});
