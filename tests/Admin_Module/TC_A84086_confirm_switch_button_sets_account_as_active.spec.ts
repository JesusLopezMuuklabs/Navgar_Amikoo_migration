...
/**
 * TC_A84086 - Confirm Switch button sets account as active
 * Original: muuk-tests/Admin_Module/TestSteps_a4f91fb8.spec.ts
 *
 * Flow:
 *   1. Login
 *   2. Open Profile Menu → Accounts (index 1)
 *   3. Assert Accounts heading is visible
 *   4. Click the "Switch" button for the Feature Flag Environment row
...
test('TC_A84086 - Confirm Switch button sets account as active', async ({ page }) => {
  ...
  // Click Switch for the Feature Flag Environment row
  await adminPage.clickSwitchForFeatureFlagEnvironment();

  // Assert "Current Account" label is visible for the switched account
