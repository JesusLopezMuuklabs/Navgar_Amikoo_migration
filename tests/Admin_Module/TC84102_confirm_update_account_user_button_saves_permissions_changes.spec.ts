...
/**
 * TC84102 - Confirm Update Account user button saves changes to the account permissions
 * Original: muuk-tests/Admin_Module/TestSteps_a4fd2124.spec.ts
 *
 * Flow:
 *   1. Login
 ...
 *   5. Assert account detail heading and permissions table columns visible
 *   6. Assert "Invite A User" button is visible
 */
...
test('TC84102 - Confirm Update Account user button saves changes to the account permissions', async ({ page }) => {
