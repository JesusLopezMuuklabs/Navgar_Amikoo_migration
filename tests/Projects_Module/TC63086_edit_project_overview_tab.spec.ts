...
test('TC63086 - edit project button opens the overview tab of the project drawer', async ({ page }) => {
  ...
  await detailPage.editProjectName("Muuk Project - Edited Name");
  await page.waitForTimeout(3000);

  // Assert change is reflected in H6
  await expect(page.locator('//h6[contains(text(),"Edited Name")]')).toBeVisible({ timeout: 60000 });
